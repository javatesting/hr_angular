...
--
-- Хост: testjava.mysql.ukraine.com.ua
...
INSERT INTO `persons` ( `name`, `last_name`, `age`) VALUES
('Ivan', 'Ivanov', 20),
('Petro', 'Petrov', 30),
('AR', 'Argentina', 40),
('BE', 'Belgium', 50);
...
--
-- Дублирующая структура для представления `emp_details_view`
--
